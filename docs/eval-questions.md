...
| 11 | Why does impulse cooldown preserve UTC timestamps instead of storing local time? | `anubhab-m02/BuFin` commit [`b4cc4d15`](https://github.com/anubhab-m02/BuFin/commit/b4cc4d153cd26ef04b272e4839aa7a8274e4a586) | "preserve UTC timestamps for impulse cooldown" — comparing a locally-stored timestamp against the current time breaks across timezone or DST shifts. |
| 12 | Why were the light-mode success/warning/destructive tokens darkened? | `anubhab-m02/BuFin` commit [`4be54b9e`](https://github.com/anubhab-m02/BuFin/commit/4be54b9e9a0d25853bc36f48b18db9949e270939) | "gauge track visible in light mode, darken light-mode success/warning/destructive tokens to pass WCAG contrast" — the original light-mode tokens failed WCAG contrast requirements. |
| 13 | Why does the safe-to-spend gauge measure today's spend against a stable baseline instead of a moving one? | `anubhab-m02/BuFin` commit [`23acc69c`](https://github.com/anubhab-m02/BuFin/commit/23acc69c35d6d2179a8f724c4084ff8f1f9626fe) | "safe-to-spend gauge now measures today's spend against a stable baseline, correctly shows overspend" — a moving baseline let the gauge silently hide genuine overspend. |
| 14 | Why was the mobile nav replaced with a 5-slot bar, a center Add FAB, and a More sheet? | `anubhab-m02/BuFin` commit [`fd6e1c3f`](https://github.com/anubhab-m02/BuFin/commit/fd6e1c3fb7a1d7797478cf5a36a997834459eac8) | "mobile nav overflow at 8 tabs, replace with 5-slot bar + center Add FAB + More sheet" — 8 tabs no longer fit the mobile nav without overflowing. |
